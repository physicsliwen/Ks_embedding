...
//fill the centrality bin information
  ...
  std::cout<<"centbin 9 is "<<mV0Dst.centBin9<<std::endl;
  mV0Dst.centBin16 = refmultCorrUtil -> getCentralityBin16();
  std::cout<<"centbin16 is "<<mV0Dst.centBin16<<std::endl;
